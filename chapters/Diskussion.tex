...
%Es handelt sich also nicht um Indexikalität der ersten Ordnung (\autoref{sec:Indexikalitaet}), bei der die Verteilung der Varianten auf unterschiedliche Register den SprachbenutzerInnen nicht bewusst ist, sondern um Indexikalität der zweiten oder dritten Ordnung: 
...
Bei der \gegenueber{} und \object{seit} zeigen sich solche regionalen Unterschiede nicht. 
...
%Erklärung für häufigeren Genitivgebrauch unter HochschulabsolventInnen: 
